---
description: DAW Issue Plan - Define 1-3 issues with success criteria
---
...
Say: "Understanding gap identified: [describe]. Recommend `/investigate` before planning."
...
Say: "Design gap identified: [describe]. Recommend `/design` before planning."
...
Say: "Architectural decision identified: [describe]. Recommend `/adr <decision-title>` before planning to evaluate options and record the decision."
...
Next: `/define-gates <issue-identifier>`
