...
### Workflow (explain methodology)

**When to use:**
- New team member needs orientation
- Questions about the methodology
- Need clarification on phase boundaries

**Command:** `/wf-workflow`

**Output:** Explains the workflow methodology, answers questions about phases and commands.
