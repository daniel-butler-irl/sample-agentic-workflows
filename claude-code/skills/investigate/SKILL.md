...
- **Yes** --> Skip to 01 Issue Plan or 02 Task Plan
...
[Ready for 01 Issue Plan / Needs Design first / Needs decomposition]
```
...
**Recommended next step:**
- Ready for `/01-issue-plan` - success criteria are clear
- Needs `/design` first - interface decisions required
